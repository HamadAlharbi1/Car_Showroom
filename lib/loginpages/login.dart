            ...
            Center(
              child: Column(
                children: [
                  ...
                  const SizedBox(height: Constant.fontsize16),
                  const Text(
                    ' بالضغط على استمرار أوكد اني قرأت و وافقت على',
                    style:
                        TextStyle(color: Color.fromARGB(255, 255, 253, 253), fontSize: 18, fontWeight: FontWeight.bold),
                  ),
                  const SizedBox(height: Constant.fontsize16),
                  InkWell(
                    onTap: (() {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      const Text(
                        ' بالإضافة الى ',
                        style: TextStyle(
                            color: Color.fromARGB(255, 255, 253, 253), fontSize: 20, fontWeight: FontWeight.bold),
                      ),
                    ],
                  ),
                ],
